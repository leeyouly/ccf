...
from ccf.spiders.meg import MegSpider
import unittest
import os.path
import logging
...
class ZhifangdiduanTests(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        data_file_path = os.path.join(dir, 'meg.html')
        f = open(data_file_path)
        html_content = f.read()
        #print html_content
        f.close()
        report_title = u'CCF MEG市场周报（1.18-1.22)'
        request = Request(url='http://www.ccf.com.cn/newscenter/detail-160000-2016012200067.shtml', 
