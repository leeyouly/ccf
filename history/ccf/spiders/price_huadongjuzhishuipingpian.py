...
class PriceHuadongjuzhishuipingpianSpider(scrapy.Spider):
    name = "price_huadongjuzhishuipingpian"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-华东聚酯水瓶片')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=15&type=dd', 
