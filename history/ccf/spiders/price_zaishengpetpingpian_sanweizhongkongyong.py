...
class PriceZaishengpetpingpianSanweizhongkongyongSpider(scrapy.Spider):
    name = "price_zaishengpetpingpian_sanweizhongkongyong"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-再生PET瓶片（三维中空用）')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=111&type=dd', 
