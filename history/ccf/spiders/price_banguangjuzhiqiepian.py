...
class PriceBanguangjuzhiqiepianSpider(scrapy.Spider):
    name = "price_banguangjuzhiqiepian"
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=14&type=dd', 
