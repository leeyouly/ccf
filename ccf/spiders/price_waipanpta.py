...
class PriceWaipanptaSpider(scrapy.Spider):
    name = "price_waipanpta"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-外盘PTA')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=4&type=dd',
