...
class PriceZhifangbanguangfdy150dSpider(scrapy.Spider):
    name = "price_zhifangbanguangfdy_150d"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-直纺半光FDY 150D/96F')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=12&type=dd',
