# -*- coding: utf-8 -*-
import scrapy
from ccf.items import OilRelationItem
import logging
import re
...
class PriceOilrelationSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-半光聚酯切片')
        self.crawler.stats.set_value('spiderlog/target_tables', ['T_CCF_OIL_RELATION'])
    ...
    def login_callback(self, response):
        # for page in range(1,287,1):
        for page in range(100,287,1):
            page_list_url = 'http://www.ccf.com.cn/newscenter/index.php?cur_row_pos=28&cur_pg_num='+str(page)+'&Class_ID=130000'
    ...
    def parse_content(self, response):
        ...
        if data_table <> []:
            ...
            for data in data_list[1:]:
                item = OilRelationItem()
                item['datadate'] = datadate
                item['product_name'] = data[0]
                item['market'] = data[1]
                item['lastday_price'] = data[2]
                item['currentday_price'] = data[3]
                item['change_price'] = data[4]
                item['unit'] = data[5]
