...
class PriceZhanjiaochangsiSpider(scrapy.Spider):
    name = "price_zhanjiaochangsi"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-粘胶长丝')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=17&type=dd',
