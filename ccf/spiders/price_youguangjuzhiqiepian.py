...
class PriceYouguangjuzhiqiepianSpider(scrapy.Spider):
    name = "price_youguangjuzhiqiepian"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-有光聚酯切片')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=39&type=dd',
