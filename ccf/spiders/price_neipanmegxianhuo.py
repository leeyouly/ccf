...
class PriceNeipanmegxianhuoSpider(scrapy.Spider):
    name = "price_neipanmegxianhuo"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-内盘MEG现货')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=5&type=dd',
