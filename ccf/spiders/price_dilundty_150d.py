...
class PriceDilundty150dSpider(scrapy.Spider):
    name = "price_dilundty_150d"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-涤纶DTY 150D/48F')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=9&type=dd',
