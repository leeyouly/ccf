...
class Price14dZhifangdiduanSpider(scrapy.Spider):
    name = "price_14d_zhifangdiduan"
    ...
    def parse(self, response):
        ...
        self.crawler.stats.set_value('spiderlog/source_name', u'中国化纤-1.4D直纺涤短')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request('http://www.ccf.com.cn/dynamic_graph/getPrice.php?monitorId=13&type=dd', 
